...
HD_PWD='/home/btech/cs1190372/col215/vivado/a5/a5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bch_to_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bch_to_display.tcl
