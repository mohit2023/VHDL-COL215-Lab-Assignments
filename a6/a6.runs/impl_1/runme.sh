...
HD_PWD='/home/btech/cs1190372/col215/vivado/a6/a6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bch_to_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bch_to_display.tcl -notrace
